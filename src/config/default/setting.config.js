...
module.exports = {
  ...
  systemName: 'Mladder Admin',          //系统名称
  copyright: '2023 ecnu dasetalent',    //copyright
  ...
  footerLinks: [                        //页面底部链接，{link: '链接地址', name: '名称/显示文字', icon: '图标，支持 ant design vue 图标库'}
    {link: 'https://mladder.shuishan.net.cn/', name: 'Mladder首页'},
    {link: 'https://github.com/bnc1010/containerManagerFrontend', icon: 'github'},
